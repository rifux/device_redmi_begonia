...
git clone -b master https://github.com/TTTT555/viper4androidFX \
    vendor/viper4androidFX
git clone -b main https://github.com/TTTT555/vendor_JamesDSPManager \
    vendor/JamesDSPManager
git clone -b main https://github.com/TTTT555/vendor_dlb \
    vendor/dlb
